...
Static mermaid is great in docs; for **runtime** inspection, install the [DevTools extension](../advanced/devtools):

1. Load unpacked from `devtools/dist` (Chrome / Edge developer mode)
2. Open your page or this site’s Playground, press <kbd>F12</kbd>
3. Switch to the **AFSM** tab for the instance tree, diagram, and timeline

With the [DevTools extension](../advanced/devtools), you can watch the live graph with current / processing highlights.
...
- [DevTools extension](../advanced/devtools) — install, panel guide, troubleshooting
